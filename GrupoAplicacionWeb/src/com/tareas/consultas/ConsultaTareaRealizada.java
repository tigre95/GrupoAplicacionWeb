...
public class ConsultaTareaRealizada extends GenericForwardComposer<Component>{
	@Wire
	...
	public void buscartareas(String criterio){
		...
		ArrayList<TareasAsignadas> lista = dbu.buscarytareasRealizada(criterio,id_tipo);
		if(lista != null){
