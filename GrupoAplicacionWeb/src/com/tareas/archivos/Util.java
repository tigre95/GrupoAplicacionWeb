...
public class Util{
	...
	public static boolean uploadFile(Media media, String ruta,String fileName) {
		return saveFile(media, ruta,fileName);
	...
	//save file
	public static boolean saveFile(Media media, String path,String fileName){
